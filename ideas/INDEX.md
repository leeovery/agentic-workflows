...
| 18 | [Inbox Working Set](inbox-working-set.md) | `workflow-start` inbox menu (working set + archive lifecycle) + discovery seed-list |
...
| 29 | ~~Seed Discovery from Multiple Linked Inbox Items~~ — merged into [#18](inbox-working-set.md) | — |
