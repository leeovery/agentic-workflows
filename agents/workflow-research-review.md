...
6. **Never ask the document to state its own pipeline position** — readiness for discussion, completion notes, coverage or review-cycle tallies. That state lives in the work unit's manifest; a finding proposing such a statement is misfiled — at most an Observation.
