...
// discussion decides the gateway and refunds and is silent on what
// the customer sees mid-confirmation, so the pick has a document to
// own it and a new subtopic to be written into.
