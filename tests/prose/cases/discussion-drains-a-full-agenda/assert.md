...
- the discussion document holds two subtopic sections, each opening
  its Context with a provenance line naming the origin topic, each
  recording its decision; the map holds both subtopics `decided`
