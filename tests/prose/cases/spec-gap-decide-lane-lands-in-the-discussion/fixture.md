...
and what they are told. The discussion decides the gateway account, the
webhook-only confirmation path and its delivery schedule, and a 30-day
refund window; it says nothing about an order the gateway never
confirms.
