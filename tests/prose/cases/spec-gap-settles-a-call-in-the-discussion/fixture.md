...
and what they are told. Its Refunds section says refunds run against
the original payment intent and never says for how long. The discussion
decides the gateway account, the webhook-only confirmation path and its
delivery schedule, and a 30-day refund window; it says nothing about an
order the gateway never confirms.
