...
- the research document is unchanged in substance — document review had
  ...
  on the way out
- no agent was dispatched at any point — research carries no review, and
  the user declined the only dive that could have been offered
- the register was never written to: no thread added, none moved
...
kept); no agent row in the topic's cache; and no discussion item, no new
map topic, no thread register, and no change to the three untouched
topics.
