# Fixture — implementation-retries-a-failed-executor
...
Nothing the capture consumer needs is undecided. The record says what a
capture names — an intent — and the order carries that id from
