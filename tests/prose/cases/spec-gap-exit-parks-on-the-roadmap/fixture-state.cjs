...
//
// The same world the new-topic exit walks. What separates the two is
// where the ground belongs: here it is a capability of its own, wanted
// later and not by this epic, so the gap exit's third destination —
// the roadmap — takes it, nothing reopens, and the specification runs
