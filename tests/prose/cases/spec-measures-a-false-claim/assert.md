...
9. the source row flips to incorporated when extraction exhausts;
   ...
   it, but a claim grounded in a design file the unit holds would be
   measurable rather than out of reach; completion verifies tracking
   and sources and puts the
