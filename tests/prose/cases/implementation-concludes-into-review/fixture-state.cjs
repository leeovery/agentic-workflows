...
// modules sit where it expects them, so the cycle this walk runs comes
// back clean and the session goes straight on to conclude. The bank is
// absent — nothing was ever deposited.
