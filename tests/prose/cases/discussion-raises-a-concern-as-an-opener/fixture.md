A search-relevance epic with two discussions concluded.
Behavioural-ranking settled signal ingestion as batch nightly
aggregation; synonym-handling settled behaviour-driven expansion and,
in its Decision, retires the hand-maintained synonym and misspelling
list "once behavioural coverage matches it".

A later behavioural-ranking sitting measured what the nightly
