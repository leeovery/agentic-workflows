...
4. the handoff carries session identity only, and the processing
...
7. the research check finds nothing under the topic's own name, then
...
8. the discussion is registered through the engine before the file
