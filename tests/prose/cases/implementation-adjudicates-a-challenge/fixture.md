# Fixture — implementation-adjudicates-a-challenge
...
- `project.defaults.project_skills` is `[]`, routing Step 3 to its
  skip-again gate.
- `project.defaults.linters` is `[]`, routing Step 4 to its
  skip-again gate.
