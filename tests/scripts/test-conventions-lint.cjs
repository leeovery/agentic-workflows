...
const RATCHET_PINS = {
  ...
  'skills/workflow-discussion-process/references/document-review.md': 1,
  ...
  'skills/workflow-research-process/references/document-review.md': 1,
  ...
  'skills/workflow-shared/references/coherence-findings-gate.md': 6,
