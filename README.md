...
- **Gates you can press.** Opt in per project and, while the terminal is the only screen attached, every menu is drawn as buttons above the prompt, where they stay put while the transcript scrolls — a click picks a row, and a second click or Enter sends it.
