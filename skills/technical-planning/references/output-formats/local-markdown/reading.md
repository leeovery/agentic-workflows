...
1. List all `.md` files in `.workflows/{work_unit}/planning/tasks/` — every file in this directory is a task file, no filtering needed
...
To read a specific task, read the file at `.workflows/{work_unit}/planning/tasks/{task-id}.md`.
...
1. List all `.md` files in `.workflows/{work_unit}/planning/tasks/`
