...
After completing the analysis, create a tracking file at `.workflows/{work-unit}/planning/review-traceability-tracking-c{N}.md` (where N is the current review cycle).
