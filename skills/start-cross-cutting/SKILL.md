...
```
> Handing off to discovery. Discovery confirms the cross-cutting
> shape and routes to research or discussion — micro routing now
> happens there, not here.
```

Invoke `/workflow-discovery-entry cross-cutting {work_unit}`.
