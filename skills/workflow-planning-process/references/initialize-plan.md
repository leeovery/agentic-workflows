...
2. Create the planning file at `.workflows/{work_unit}/planning/{topic}/planning.md` using the **Title** template from **[planning-file-schema.md](planning-file-schema.md)**.
