...
```bash
node .claude/skills/workflow-engine/scripts/engine.cjs discovery-map add {work_unit} {name} --routing {routing} --source "{source}" --summary "{summary}" --description "{description}"
```
