...
**If the user offers a path in answer to any of these** — a log, an export, a screenshot: follow **A. Land It** in **[landing-shared-files.md](../../workflow-shared/references/landing-shared-files.md)**. It lands as an import rather than being read where it sits.
