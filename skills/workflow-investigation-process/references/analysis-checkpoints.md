...
Only at `check-ins` depth. When a hypothesis resolves — `confirmed` or `ruled-out` — pause and let the user steer. Open with one sentence above the board, written as markdown (not a code block) — what just got established and what it means, in product terms.
