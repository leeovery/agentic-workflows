...
1. **Check existing context**: Read docs in `.workflows/{work_unit}/research/` to understand what's already been explored.
...
4. **Document as you go**: Don't defer writing to the end. Capture insights in `.workflows/{work_unit}/research/` using semantic filenames. Ask before documenting: "Shall I capture that?"
