...
// `awaiting` (the discussion item's live evidence-wait ids) appends
// `awaiting E1` directly after the lifecycle — the row's discussion is
// blocked pending experiment evidence, released when the experiment
